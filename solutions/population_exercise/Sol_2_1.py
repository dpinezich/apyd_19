...
def get_clean_country_list():
    ...
    and save them to a pickle file if there is data for a 49yr old man
    """
    ...
    clean_country_list = []
    black_list_country = ['Less developed regions',
    ...
    for country in countries_list:
        ...
        response = requests.get(
            "https://d6wn6bmjj722w.population.io/1.0/life-expectancy/remaining/male/{}/2001-05-11/49y2m/".format(country))
        #response = requests.get(
...
def run_exercise():
    ...
    print("There are {} countries fetched after cleaning".format(len(clean_country_list)))
